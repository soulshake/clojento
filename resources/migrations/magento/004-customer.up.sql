CREATE TABLE `customer_entity` (
  ...
  `primary_client_number` varchar(64) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Customer Entity';
...
) ENGINE=InnoDB AUTO_INCREMENT=206620 DEFAULT CHARSET=utf8 COMMENT='Customer Entity Datetime';
...
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='Customer Entity Int';
...
) ENGINE=InnoDB AUTO_INCREMENT=1079252 DEFAULT CHARSET=utf8 COMMENT='Customer Entity Varchar';
...
) ENGINE=InnoDB AUTO_INCREMENT=377271 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Customer Address Entity';
...
) ENGINE=InnoDB AUTO_INCREMENT=547068 DEFAULT CHARSET=utf8 COMMENT='Customer Address Entity Int';
...
) ENGINE=InnoDB AUTO_INCREMENT=384952 DEFAULT CHARSET=utf8 COMMENT='Customer Address Entity Text';
...
) ENGINE=InnoDB AUTO_INCREMENT=2309353 DEFAULT CHARSET=utf8 COMMENT='Customer Address Entity Varchar';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Customer Group';

--;;

CREATE TABLE `customer_service_correspondence` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_CUSTOMER_SERVICE_CUSTOMER` (`customer_id`),
  CONSTRAINT `FK_CUSTOMER_SERVICE_CUSTOMER` FOREIGN KEY (`customer_id`) REFERENCES `customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=17919 DEFAULT CHARSET=utf8;
